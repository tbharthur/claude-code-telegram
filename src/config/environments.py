...
class ProductionConfig:
    ...
    # Relaxed limits for Claude Max subscription
    claude_max_cost_per_user: float = 1000.0  # High limit (Max subscription)
    rate_limit_requests: int = 100  # Reasonable rate limiting
